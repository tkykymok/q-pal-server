...
var CustomerTableColumns = struct {
	...
	CreatedByType: "customers.created_by_type",
	UpdatedBy:     "customers.updated_by",
	UpdatedByType: "customers.updated_by_type",
}
...
var CustomerWhere = struct {
	...
	CreatedBy:     whereHelpernull_Int{field: "`customers`.`created_by`"},
	CreatedByType: whereHelperstring{field: "`customers`.`created_by_type`"},
	UpdatedBy:     whereHelpernull_Int{field: "`customers`.`updated_by`"},
	UpdatedByType: whereHelperstring{field: "`customers`.`updated_by_type`"},
}
...
func (r *customerR) GetFavoriteStores() FavoriteStoreSlice {
	if r == nil {
		return nil
	}
...
var (
	customerAllColumns            = []string{"customer_id", "cognito_user_id", "name", "email", "gender", "birthday", "created_at", "updated_at", "created_by", "created_by_type", "updated_by", "updated_by_type"}
	customerColumnsWithoutDefault = []string{"customer_id", "cognito_user_id", "name", "email", "gender", "birthday"}
	customerColumnsWithDefault    = []string{"created_at", "updated_at", "created_by", "created_by_type", "updated_by", "updated_by_type"}
...
func (o *Customer) FavoriteStores(mods ...qm.QueryMod) favoriteStoreQuery {
...
func (customerL) LoadFavoriteStores(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomer interface{}, mods queries.Applicator) error {
	var slice []*Customer
	var object *Customer
	...
	query := NewQuery(
		...
		qm.WhereIn(`favorite_stores.customer_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Customer) AddFavoriteStoresG(ctx context.Context, insert bool, related ...*FavoriteStore) error {
...
// Appends related to o.R.FavoriteStores.
// Sets related.R.Customer appropriately.
func (o *Customer) AddFavoriteStores(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FavoriteStore) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.CustomerID, rel.CustomerID, rel.StoreID}
